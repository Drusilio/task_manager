 ...
 */
final class Version20230215130728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE responsible_person (id INT AUTO_INCREMENT NOT NULL, name LONGTEXT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_2DC2A162D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, responsible_person_id INT DEFAULT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', description LONGTEXT NOT NULL, deadline DATETIME NOT NULL, status TINYINT(1) NOT NULL, file LONGTEXT NOT NULL, completion_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_527EDB25D17F50A6 (uuid), INDEX IDX_527EDB25EF64F467 (responsible_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
